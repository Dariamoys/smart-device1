...
/* harmony import */ var _modules_phone_mask_phone_mask__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/phone-mask/phone-mask */ "./js/modules/phone-mask/phone-mask.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_phone_mask_phone_mask__WEBPACK_IMPORTED_MODULE_4__["initPhoneMask"])();
...
var Accordions = /*#__PURE__*/function () {
  ...
  _createClass(Accordions, [{
    ...
    value: function _documentClickHandler(evt) {
      ...
      var button = document.querySelector('[data-accordion="button"]');
  ...
  _createClass(Form, [{
    ...
    value: function _initValidate(parent) {
      ...
      form.addEventListener('submit', function (event) {
        event.preventDefault();
        _this3._onFormSubmit(event, callback);
      });
...
var Validator = /*#__PURE__*/function () {
  ...
  _createClass(Validator, [{
    ...
    value: function validateFormElement(formElement) {
      ...
      if (!parent.hasAttribute('data-required')) {
        var removeElement = parent.querySelector('input') || parent.querySelector('textarea');
    ...
    value: function _fullValidate(items) {
      ...
      items.forEach(function (item) {
        var formElement = item.querySelector('input') || item.querySelector('textarea');
